            ...
            >
              <div className="lg:grid lg:grid-cols-2 lg:gap-16">
                <div className="lg:pb-16">
                  <div className="bg-gradient-to-r from-emerald-300 to-sky-400 bg-clip-text inline-flex font-bold uppercase tracking-widest text-sm gap-2 text-transparent">
